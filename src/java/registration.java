...
Connection con=null;
	...
	try {
            ...
            int add=st1.executeUpdate("insert into userdetails values('"+fullname+"','"+username+"','"+password+"','"+prof+"','"+mobile1+"','"+emailid1+"')");
           
            
            rd=req.getRequestDispatcher("signupsuccess.jsp");
            rd.forward(req,res);
        } catch(Exception e2) {
