		...
		Statement st,st1,st2,st3,st4;
              ...
              <tr>
                <form id="form1" method="post" name="form1" action="ViewMessage">
                  <td><input type="radio" name="filSelect" value="<%=id%>" /><%=id%></td>
          ...
          <form id="form2" name="form2" method="post" action="ReceiveKey">
            <table width="366" height="242" border="0">
              ...
              <tr>
                <td>Receiver</td>
                <td><label>
                  <input name="username" type="text" id="username" value="<%=session.getAttribute("username")%>" />
                </label></td>
              </tr>
              <tr>
