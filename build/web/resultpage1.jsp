    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div align="center">
            <form id="form1" name="form1" method="post" action="SecretKeyGeneration">
              <table width="327" height="297" border="0">
                <tr>
                ...
                <tr>
                  <td colspan="2"><div align="center">
                      <label>
                      <input type="submit" name="Submit" value="Secret Key Generation" />
                      </label>
                      <p>
