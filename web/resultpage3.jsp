    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div align="center">
            <form id="form1" name="form1" method="post" action="ASCIIcodeGeneration">
              <table width="327" height="487" border="0">
                <tr>
                ...
                <tr>
                  <td><div align="center">Cover Message</div></td>
                  <td><textarea name="cmessage" readonly="true" id="cmessage"><%=session.getAttribute("cmessage")%></textarea></td>
                </tr>
                <tr>
                  <td><div align="center">Secret Key </div></td>
                  <td><input name="sk" type="text" readonly="true" id="sk" value="<%=session.getAttribute("sk")%>" /></td>
                </tr>
                <tr>
                  <td colspan="2"><div align="center">
                      ...
                      <p class="style21">Stego Message generated and sent to receiver...  </p>
                  </div></td>
                </tr>
                <tr>
                  <td><div align="center">Message ASCII </div></td>
                  <td><textarea name="textarea" readonly="true" id="textarea"><%=session.getAttribute("mascii")%></textarea></td>
                </tr>
                <tr>
                  <td><div align="center">Cover Message ASCII </div></td>
                  <td><textarea name="textarea2" readonly="true" id="textarea2"><%=session.getAttribute("cascii")%></textarea></td>
                </tr>
                <tr>
                  <td><div align="center">Stego Message </div></td>
                  <td><textarea name="textarea3" readonly="true" id="textarea3"><%=session.getAttribute("smessage")%></textarea></td>
                </tr>
              </table>
            </form>
          </div>
