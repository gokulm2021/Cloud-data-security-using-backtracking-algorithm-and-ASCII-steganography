...
.style17 {color: #0099FF; font-size: 16px; font-weight: bold; }
        ...
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="userlogin">
            <table width="428" height="489" border="0">
              <tr>
                <td width="361" height="240" colspan="2"><div align="center"><img src="images/img1.jpg" width="396" height="202" alt="" class="fl" /></div></td>
              </tr>
