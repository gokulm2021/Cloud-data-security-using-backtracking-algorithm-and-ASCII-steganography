    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <p align="center" class="infopost style19 style20">User Registration Page </p>
          <form id="form1" name="form1" method="post" action="registration">
            <table width="428" height="489" border="0">
              <tr>
                <td width="361" height="240" colspan="2"><div align="center">
                  <p class="style21">User Registered successfully... </p>
                  <table width="364" height="362" border="0">
                    <tr>
                      <td><span class="style19">Fullname</span></td>
                      <td><label>
                        <input name="fullname" type="text" id="fullname" />
                      </label></td>
                    </tr>
                    <tr>
                      <td><span class="style19">Username</span></td>
                      <td><label>
                    ...
                    <tr>
                      <td><span class="style19">Profession</span></td>
                      <td><label>
                        <input name="prof" type="text" id="prof" />
                      </label></td>
                    </tr>
                    <tr>
                      <td><span class="style19">Mobile</span></td>
                      <td><label>
                        <input name="mobile" type="text" id="mobile" />
                      </label></td>
                    </tr>
                    <tr>
                      <td><span class="style19">Email Id </span></td>
                      <td><label>
                    ...
                    <tr>
                      <td height="81" colspan="2"><div align="center">
                          ...
                          <p><a href="login.jsp" class="style22">Goto Login </a> </p>
                      </div></td>
                    </tr>
                  </table>
                </div></td>
              ...
              <tr>
                <td colspan="2"><a href="admin.jsp">
                  <label></label>
                  </a>
                  <div align="center">
                    <a href="admin.jsp"></a></div></td></tr>
            </table>
          </form>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li class="style4"><a href="register.jsp">User Registration  </a></li>
            <li class="style4"><a href="login.jsp">User Login  </a><span class="style4"><a href="userlogin.jsp"></a></span></li>
