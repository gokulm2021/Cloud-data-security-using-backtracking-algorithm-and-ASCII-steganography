    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <p align="center" class="infopost style19 style20">User Login Page </p>
          <form id="form1" name="form1" method="post" action="login">
            <table width="428" height="489" border="0">
              <tr>
                <td width="361" height="240" colspan="2"><div align="center">
                  <p class="style21">Invalid username or password... </p>
                  <table width="364" height="261" border="0">
                    ...
                    <tr>
                      <td height="81" colspan="2"><div align="center">
                          ...
                          <p><a href="register.jsp">Goto Registration </a> </p>
                      </div></td>
                    </tr>
                  </table>
                </div></td>
